<nav x-data="{ scrolled: false }" x-init="window.addEventListener('scroll', () => {
    ...
    })" x-bind:class="{ 'md:bg-transparent md:dark:bg-transparent bg-blue-800 dark:bg-slate-800': !scrolled, 'bg-blue-800 dark:bg-slate-800': scrolled }" class="md:fixed z-50 p-4 w-full">
