<div class="w-full md:h-96 bg-cover bg-center h-56 flex items-center justify-center" style="background-image: url('{{asset('images/searchbackground.jpg')}}">
    <div class="flex text-lg md:w-96 w-60">
        ...
        <input type="text" id="website-admin" class="rounded-none rounded-r-lg bg-transparentBlack text-white border focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full p-2.5 text-lg" placeholder="Search Music ...">
    </div>
</div>