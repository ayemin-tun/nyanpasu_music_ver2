<section x-data="{isOpen:false}">
    <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification" class="inline-flex items-center text-sm font-medium text-center text-white  dark:hover:text-white dark:text-gray-400" type="button" @click="isOpen = !isOpen">
    ...
    <div id="dropdownToggle" x-show="isOpen" @click.outside="isOpen=false" class="z-10 absolute md:right-3 right-1 bg-white divide-y divide-gray-100 rounded-lg shadow w-72 dark:bg-gray-700 dark:divide-gray-600">
        ...
        <div class="py-2 px-2">
            <a href="#" class=" px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white flex gap-2 items-center font-medium">
